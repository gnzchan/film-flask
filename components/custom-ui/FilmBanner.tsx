...
const FilmBanner: React.FC<FilmBannerProps> = ({ film }) => {
  ...
  return (
    <div
      className="sticky top-0 flex aspect-video h-auto min-h-[60%] w-full flex-col items-center justify-end bg-white bg-cover bg-center p-1 dark:bg-black sm:items-start sm:p-5"
      style={{
        backgroundImage: `
